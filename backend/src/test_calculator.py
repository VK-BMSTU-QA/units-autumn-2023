...
class TestCalculator(unittest.TestCase):
    ...
    def test_substraction(self):
        ...
        self.assertAlmostEqual(self.calculator.subtraction(22.23, 15.71), 6.52, msg="Float numbers")
    ...
    def test_multiplication(self):
        ...
        self.assertAlmostEqual(self.calculator.multiplication(24.23, 12.56), 304.3288, msg="Float numbers")
    ...
    def test_division(self):
        ...
        self.assertAlmostEqual(self.calculator.division(24.23, 12.56), 1.929140127388535, msg="Float numbers")
    ...
    def test_adsolute(self):
        ...
        self.assertAlmostEqual(self.calculator.adsolute(0.234), 0.234, msg="Positive float")
        self.assertAlmostEqual(self.calculator.adsolute(-0.234), 0.234, msg="Negative float")
    ...
    def test_ln(self):
        ...
        self.assertAlmostEqual(self.calculator.ln(8), 2.0794415416798357, msg="ln(positive number)")
    ...
    def test_sqrt(self):
        ...
        self.assertAlmostEqual(self.calculator.sqrt(-5), (1.3691967456605067e-16+2.23606797749979j))
    ...
    def test_nth_root(self):
        ...
        self.assertAlmostEqual(self.calculator.nth_root(-5, 2), (1.3691967456605067e-16 + 2.23606797749979j))
